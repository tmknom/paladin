...
from paladin.check.types import CheckResult, ParsedFile, ParsedFiles, TargetFiles
...
class TestCheckResult:
    ...
    def test_init_正常系_target_filesとparsed_filesを保持すること(self):
        # Arrange
        target_files = TargetFiles(files=(Path("a.py"),))
        parsed_files = ParsedFiles(files=())

        # Act
        result = CheckResult(target_files=target_files, parsed_files=parsed_files)
